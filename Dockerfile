...
COPY ["EbisuWebApi.Crosscutting.Exceptions/EbisuWebApi.Crosscutting.Exceptions.csproj", "EbisuWebApi.Crosscutting.Exceptions/"]
...
COPY ["EbisuWebApi.Domain.Validation/EbisuWebApi.Domain.Validation.csproj", "EbisuWebApi.Domain.Validation/"]
