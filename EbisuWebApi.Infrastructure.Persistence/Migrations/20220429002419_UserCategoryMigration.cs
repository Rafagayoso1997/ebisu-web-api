...
{
    public partial class UserCategoryMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UsersCategoryId = table.Column<int>(type: "int", nullable: false),
                    UsersUserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryEntityUserEntity", x => new { x.UsersCategoryId, x.UsersUserId });
                    table.ForeignKey(
                        name: "FK_CategoryEntityUserEntity_Category_UsersCategoryId",
                        column: x => x.UsersCategoryId,
