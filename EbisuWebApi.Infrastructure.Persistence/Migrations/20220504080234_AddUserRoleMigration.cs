    ...
    public partial class AddUserRoleMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Comida", "asd", true, "Comida", "Gasto" });

            migrationBuilder.InsertData(
                table: "Category",
                columns: new[] { "CategoryId", "Description", "ImageUrl", "IsDefault", "Name", "Type" },
                values: new object[] { 2, "Transporte", "asd", true, "Transporte", "Gasto" });

            migrationBuilder.InsertData(
                table: "Category",
                columns: new[] { "CategoryId", "Description", "ImageUrl", "IsDefault", "Name", "Type" },
                values: new object[] { 3, "Salario", "asd", true, "Salario", "Ingreso" });
